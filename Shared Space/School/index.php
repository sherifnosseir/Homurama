...
<html>
 <head>
  <title>Shared School Space</title>
...
$(document).ready(function(){
  ...
  .uploadify({
	...
	'fileExt' 	: '*.pdf; *.pptx; *.ppt; *.xml; *.jpg; *.png; *.doc; *.docx; *.xls; *.ios; *.dmg; *.rar; *.zip; *.exe; *.bmp',
	'fileDesc'  : 'School Files'
  });
  alert(notes.user);
});
</script>
 ...
 <body>
<h1 align='center'>Shared School Space</h1>

<?php

$pos = strripos(getcwd(), "\\School");
