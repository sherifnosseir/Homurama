...
<html>
 <head>
  <title>Shared Video Space</title>
...
$(document).ready(function(){
  ...
  .uploadify({
	...
	'fileExt' 	: '*.mp4; *.mpeg-4; *.h.261; *.h.263; *.h.264; *.avi; *.wmv; *.mpg; *.mpeg; *.mov; *.ram; *.rm; *.swf; *.flv;, *.mkv;',
 ...
 <body>
<h1 align='center'>Shared Video Space</h1>

<?php

$pos = strripos(getcwd(), "\\Videos");
